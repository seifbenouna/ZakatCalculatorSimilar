...
public class IrrigationNaturelle extends JFrame implements ActionListener {
	...
	public IrrigationNaturelle()
	{
		this.setBounds(450, 400, 350,370);
		this.setTitle("Zakat de Irrigation Naturelle");
		
		this.setResizable(false);
		this.setLayout(null);
		title=new JLabel("Irrigation Naturelle");title.setForeground(violet);
		...
		img=new ImageIcon(this.getClass().getResource("/image/irrnat.png"));
		limg=new JLabel(img);
		
				
		
		pan.setBounds(0,0,this.getWidth(),this.getHeight());
		title.setBounds(100, 0, 180, 30);title.setFont(f);
		lab1.setBounds(10, 20, 200, 50);
		tf.setBounds(lab1.getWidth()-40, title.getY()+33,  80, 30);
